  ...
  return (
    <>
      <div  className="hero lg:px-28 lg:py-32 py-7 lg:mt-16 text-center">
        ...
        <div data-aos="fade"  data-aos-delay="200" className="text-center text-gray-300 lg:text-xl md:text-lg font-normal font-['Space Grotesk'] lg:leading-7 leading-normal
        text-base mb-10">
          I blend exquisite design with impeccable functionality for an
          exceptional <br />
          user experience, while keeping users captivated.
        </div>
        <div data-aos="fade-down" data-aos-delay="300" className="flex justify-center items-center float">
