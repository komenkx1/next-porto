  ...
  return (
    <>
      <div className="ttile">
        <div data-aos="fade-left">
          ...
          >
            {futureCategory.map((category, index) => {
              ...
              return (
                <span key={index}  data-aos="fade-right" className="flex gap-2">
                  {!isLastIndex ? (
        ...
        <div data-aos="fade-up" data-aos-delay="500" className="content my-10 grid lg:grid-cols-3 md:grid-cols-2 gap-5 justify-center">
          <PortoFolioCard />
          <PortoFolioCard />
          <PortoFolioCard />
        </div>
        <div data-aos="fade-up" className="flex justify-center lg:py-8 md:py-6 pb-5">
